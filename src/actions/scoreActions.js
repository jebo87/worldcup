...
export const startSetScore = (score) => {
    return (dispatch) => {
        ...
        const myRequest = new Request('https://us-central1-***REMOVED***.cloudfunctions.net/date?format=YYYY-MM-DD%20HH:mm', myInit);
        ...
        fetch(myRequest)
            ...
            .then((responseJSON) => { //actual result
                ...
                if (serverTime.isSameOrBefore(matchTime)) {
                    ...
                    dispatch(setScore({error:'partido ya iniciado'}));
                }
            });
