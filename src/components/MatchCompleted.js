			...
			<div className="match__finished">
				...
				<div className="match_bottom">
					<div className="match_bottom_text">
						<div className="match_bottom_text_pink">Actual match result:</div>
						{this.props.match.teamA} {this.props.match['match_score'].scoreA} - {this.props.match.teamB}{' '}
						{this.props.match['match_score'].scoreB}
					</div>
					<div className="match_bottom_text">
						<div className="match_bottom_text_pink">Points won:</div>
						{(this.scores && this.scores.points) || <span>0</span>}
						<div className="match_others_completed">
							<button className="button_nav_completed" onClick={this.loadMatchScores}>
								see score list
							</button>
						</div>
					</div>
