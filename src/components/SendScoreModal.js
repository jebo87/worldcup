...
class SendScoreModal extends React.Component {
    ...
    sendScore = () => {
        this.props.dispatch(startSetScore({ ...this.props.score, scoreA: this.state.scoreA, scoreB: this.state.scoreB }));
        this.setState(()=>({
            scoreA:0,
            scoreB:0
        }));
    ...
    afterModalOpen = () => {
        this.props.score.scoreA !== 0 ? this.setState(() => ({ scoreA: this.props.score.scoreA })) : 0;
        this.props.score.scoreB !== 0 ? this.setState(() => ({ scoreB: this.props.score.scoreB })) : 0;
    ...
    render() {
        ...
        if (this.state.matchEnabled) {
            ...
            return (
                ...
                className="modal"
            >
            <div className="layout">El partido ya ha comenzado!</div></Modal>
            )
        }
