...
class HomePage extends React.Component {
    ...
    toggleColor = (color) => {
        ...
        const items_fg = ['.fecha_title', '.match_score', '.vs', '.score','.match_bottom_text_pink','.score_number'];
        items_bg.map(item => {
            ...
            <React.Fragment>
                ...
                <div className="home_page">
                    <div className="group_phase">
                        ...
                        {
                        // <button onClick={() => { this.toggleColor('#FF5252') }} className="colors" style={{ background: '#FF5252' }}></button>
                        // <button onClick={() => { this.toggleColor('#0288D1') }} className="colors" style={{ background: '#0288D1' }}></button>
                        }
                    </div>
